...
object Dependencies {
  ...
  val AwsSdk2SqsVersion = "2.25.11" // latest AwsSdk2Version causes us test issues with SQS
  ...
  val OrientDB = Seq(
    libraryDependencies ++= JacksonDatabindDependencies ++ Seq(
      ("com.orientechnologies" % "orientdb-graphdb" % "3.2.27")
        .exclude("com.tinkerpop.blueprints", "blueprints-core"),
      "com.orientechnologies" % "orientdb-object" % "3.2.27"))
